...
function WebhooksPage({ project, webhooks, selectedWebhook, selectedWebhookValue, deliveries, busy, onWebhookChange, onCreate, onRotate, onCompromised, onDisable, onRefresh, onReplay }: { project: Project; webhooks: Webhook[]; selectedWebhook: string; selectedWebhookValue: Webhook | null; deliveries: Delivery[]; busy: string; onWebhookChange: (value: string) => void; onCreate: (event: FormEvent<HTMLFormElement>) => void; onRotate: (webhook: Webhook) => void; onCompromised: (webhook: Webhook) => void; onDisable: (webhook: Webhook) => void; onRefresh: () => void; onReplay: (delivery: Delivery) => void }) {
