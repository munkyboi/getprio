...
| Test accounts and tester app | Sandbox test accounts are connected to project-scoped provisioning. The portal lists up to two accounts, shows generated credentials once, and resets expiry, sessions, and registered devices. App distribution links remain separately unprovisioned. |
