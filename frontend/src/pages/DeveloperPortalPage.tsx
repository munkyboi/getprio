    ...
    <main className="developer-portal" data-testid="developer-portal">
      ...
      <section className="developer-portal-section" id="documentation" aria-labelledby="documentation-title">
        ...
        <div className="developer-portal-grid">
          ...
          <article><strong>API reference</strong><p>The versioned preview contract is documented with browser execution disabled.</p><a className="developer-portal-doc-link" href="/reference">Open the API reference</a><a className="developer-portal-doc-link" href="https://api.getprio.online/v1/openapi.json">View the live OpenAPI JSON</a></article>
