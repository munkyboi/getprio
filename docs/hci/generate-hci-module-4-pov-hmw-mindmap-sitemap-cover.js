...
const out = path.join(__dirname, "getprio-hci-module-4-pov-hmw-mindmap-sitemap-cover.pdf");
...
const details = {
  ...
  module: "HCI Module 4",
  deliverable: "POV to HMW to Mind Map to Site Map",
  figmaUrl:
    "https://www.figma.com/design/rwKhBnsKjEBprhQpC5kiez/GetPrio-HCI---IAS--UI-UX-?node-id=71-2"
};
...
centered("POV to HMW to Mind Map", 694, 16, { bold: true, color: colors.ink });
centered("to Site Map", 668, 15, { bold: true, color: colors.ink });
paragraph(
  "Cover sheet for HCI Module 4 synthesis boards: POV, HMW, mind map, and role-aware site map.",
  86,
  636,
  72,
  10,
...
labelValue("Deliverable", details.deliverable, 336, 474, 210);
...
card(
  "Synthesis Focus",
  [
    "Turns research insights into prototype structure.",
    "Connects customer, vendor, platform, security, and recovery flows."
  ],
  307,
  124,
  234,
