...
const out = path.join(__dirname, "getprio-hci-module-3-empathy-research-cover.pdf");
...
const details = {
  ...
  module: "HCI Module 3",
  deliverable: "Empathy & Research Package — Complete Submission",
  figmaUrl:
    "https://www.figma.com/design/rwKhBnsKjEBprhQpC5kiez/GetPrio-HCI---IAS--UI-UX-?node-id=67-2"
};
...
centered("Empathy & Research Package", 694, 17, { bold: true, color: colors.ink });
centered("Complete Submission — Parts 1, 2 & 3", 668, 13.5, { bold: true, color: colors.ink });
paragraph(
  "Cover sheet for the HCI Module 3 complete empathy and research package for the primary GetPrio customer persona.",
  86,
  636,
  72,
  10,
...
card(
  ...
  [
    ...
    "Part 2 empathy map.",
    "Part 3 synthesis and HMW questions.",
...
card(
  "Primary Focus",
  [
    "Primary persona: Mika Santos, mobile customer joining a queue through QR.",
    "Focus: empathy, uncertainty, security clarity, recovery, and privacy-aware queue status."
  ],
  307,
  124,
  234,
