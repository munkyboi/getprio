...
const out = path.join(__dirname, "getprio-hci-module-3-journey-mental-model-cover.pdf");
...
const details = {
  ...
  module: "HCI Module 3",
  deliverable: "User Journey Map + Mental Model Gap Analysis",
  figmaUrl:
    "https://www.figma.com/design/rwKhBnsKjEBprhQpC5kiez/GetPrio-HCI---IAS--UI-UX-?node-id=65-2"
};
...
centered("HCI MODULE 3 DELIVERABLE", 770, 10, { bold: true, color: colors.orange });
centered("GetPrio", 728, 34, { bold: true, color: colors.ink });
centered("User Journey Map", 694, 17, { bold: true, color: colors.ink });
centered("+ Mental Model Gap Analysis", 668, 15, { bold: true, color: colors.ink });
paragraph(
  "Cover sheet for the HCI Module 3 primary persona journey map and mental model gap analysis deliverable.",
  86,
  636,
  72,
  10,
...
card(
  "Included Boards",
  [
    "Deliverable overview and primary persona framing.",
    "Primary persona journey map and emotion curve.",
    "Mental model gap analysis.",
    "Intervention plan and usability metrics."
  ],
  54,
  124,
  234,
...
card(
  "Primary Persona",
  [
    "Mika Santos, mobile customer joining a queue through QR.",
    "Focus: confidence, status visibility, recovery, privacy, and security clarity."
  ],
  307,
  124,
  234,
