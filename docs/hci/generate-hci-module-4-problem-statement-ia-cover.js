...
const out = path.join(__dirname, "getprio-hci-module-4-problem-statement-ia-cover.pdf");
...
const details = {
  ...
  module: "HCI Module 4",
  deliverable: "Problem Statement + Information Architecture Document",
  figmaUrl:
    "https://www.figma.com/design/rwKhBnsKjEBprhQpC5kiez/GetPrio-HCI---IAS--UI-UX-?node-id=76-2"
};
...
centered("HCI MODULE 4 DELIVERABLE", 770, 10, { bold: true, color: colors.orange });
centered("GetPrio", 728, 34, { bold: true, color: colors.ink });
centered("Problem Statement", 694, 17, { bold: true, color: colors.ink });
centered("+ Information Architecture", 668, 15, { bold: true, color: colors.ink });
paragraph(
  "Cover sheet for the HCI Module 4 problem statement and information architecture document.",
  86,
  636,
  72,
  10,
...
labelValue("Deliverable", details.deliverable, 336, 474, 190);
...
card(
  ...
  [
    ...
    "IA principles and content model.",
    "Role-aware IA site map.",
    "Navigation rules and screen inventory."
  ],
  54,
  124,
  234,
...
card(
  "IA Focus",
  [
    "Organizes GetPrio around role, task frequency, security states, and recovery paths.",
    "Keeps customer, vendor, platform, and public views separate."
  ],
  307,
  124,
  234,
