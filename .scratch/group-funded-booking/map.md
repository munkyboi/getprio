...
- [17 — Contributor reservation admission and presentation](./issues/17-contributor-reservation-admission-and-presentation.md) — open; blocked by Submitted-proof contributor reservation rule.
