...
<tr><td align="center" style="padding:32px 24px 40px;"><img src="${escapeHtml(appUrl("/email/v1/getprio-logo.png"))}" width="80" height="60" alt="GetPrio" style="display:block;border:0;width:80px;height:60px;"></td></tr>
